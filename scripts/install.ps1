...
function Get-LatestVersion {
    try {
        $latestRelease = Invoke-RestMethod -Uri "https://api.github.com/repos/farukbrowser/cursor-free-vip/releases/latest"
        return @{
...
Write-Host "Created by farukbrowser`n" -ForegroundColor $Theme.Info
